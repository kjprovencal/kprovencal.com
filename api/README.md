...
| `GET`  | `/admin/rsvps`           | Event RSVPs JSON list (authenticated)                                  |
| `GET`  | `/admin/wedding-rsvps`  | Wedding RSVPs JSON list (authenticated)                                |
